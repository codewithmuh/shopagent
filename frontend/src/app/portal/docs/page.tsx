...
export default function PortalDocsPage() {
  const [activeSection, setActiveSection] = useState("system-flow");
  const contentRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    const scrollRoot = document.getElementById("portal-main");
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              <p className="text-sm text-gray-500 leading-relaxed ml-10">
                ...
                <Link href="/portal/dashboard" className="text-emerald-600 underline font-medium">Dashboard</Link>.
              </p>
            </div>
...
// → Respond: { success: true, transaction_id: "tx_abc123" }`}
                />
              </div>
            </div>
        ...
        <Section id="authentication" title="Authentication">
          <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4">
            ...
            <p className="text-sm text-emerald-700 leading-relaxed">
              All API requests must include your credentials via HTTP headers.
              You can find your Client ID and Secret Key on the{" "}
              <Link
...
Content-Type: application/json`}
        ...
        <Section id="webhooks" title="Webhooks">
          <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
            ...
            <p className="text-sm text-amber-700 leading-relaxed">
              ...
              header. Verify this signature using your Webhook Secret to ensure
  ...
  "timestamp": "2026-03-04T12:00:05Z"
          ...
          {/* order_followup event */}
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            <div className="flex items-center gap-2 mb-3">
              <span className="px-2 py-0.5 text-xs font-bold rounded bg-teal-100 text-teal-700 uppercase tracking-wide">POST</span>
              <span className="text-sm font-semibold text-gray-900">order_followup</span>
            </div>
            <p className="text-sm text-gray-500 mb-3">
              Sent automatically <strong>3 days after a successful order</strong> to ask if the user received their delivery.
              Use this to trigger a push notification, SMS, or in-app message to your user.
              No response required — respond with <code className="text-xs font-mono bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded">200 OK</code>.
            </p>
            <CodeBlock
              language="JSON"
              code={`{
  ...
  "amount": "249.99",
  "currency": "PKR",
  "message": "Hi Ahmed! Just checking in on your recent order for Smart Watch Pro (42mm Black). Did your package arrive okay?",
  "order_created_at": "2026-03-08T10:30:00Z",
  "timestamp": "2026-03-11T10:30:00Z"
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-sm text-gray-500 mb-3">
              Your webhook endpoint should respond with a JSON body indicating
              success:
            </p>
            <CodeBlock
              language="JSON"
